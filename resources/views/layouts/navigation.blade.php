<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <!-- Responsive Navigation Menu on Small Devices -->
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('blog.service')" :active="request()->routeIs('blog.service')">
                {{ __('Our Services') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('user.profile', auth()->id())" :active="request()->routeIs('user.profile')">
                {{ __('Profile') }}
            </x-responsive-nav-link>
        </div>
